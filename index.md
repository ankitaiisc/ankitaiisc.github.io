...
<p align="justify"> My research is in <strong> AI and society.</strong> I develop AI tools for societal decision-making, with a focus on law, public policy, and health. More specifically, I develop computational methods to understand <strong>argumentative reasoning</strong> in high-stakes social settings, focusing on modeling complex reasoning patterns and rich semantic structures in argumentative and narrative texts. To this end, I develop new <strong>machine learning, natural language processing, and computational social science </strong> methods and address key challenges in their use, including reliability, efficiency, and transparency.
...
<p align="justify"><strong>I am on the academic and industry job market for positions starting Summer/Fall 2026!</strong> If you think a position would be a good fit, please do reach out. <a href="https://ankitaiisc.github.io/assets/Research_Statement_Ankita_Gupta_2026.pdf">Research Statement</a></p>
